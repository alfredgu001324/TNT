...
class Policy(BasePolicy):
    ...
    def act(self, obs: Dict[str, Any]):
        ...
        for agent_id, agent_obs in obs.items():
            single_vehicle_data = s2a(self.vehicle_data[agent_id], agent_obs) ############## A panda dataframe
            ...
            forecasted_trajectories = self.trainer.predict(graph_data, convert_coordinate=False)  # shape(forecatsed_tr) = (6, 30, 2)
