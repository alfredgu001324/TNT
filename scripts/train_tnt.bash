...
python train_tnt.py -d dataset/interm_data -o run/tnt/ -a -b 64 -c --lr 0.0010 -luf 10 -ldr 0.1
# python train_tnt.py -d dataset/interm_data -o run/tnt/ -a -b 64 -c --lr 0.0010 -luf 10 -ldr 0.1 -rm /home/kyber/Desktop/unused/TNT/run/tnt/10-19-18-52/best_TNT.pth
